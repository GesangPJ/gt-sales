...
export const KolomEditProduk: ColumnDef<EditProduk>[] = [
    {
    id: "no",
    // header: "No",
    header: () => {
    ...
    cell: ({row}) => {
      ...
      return (
        ...
        <Button size="sm" variant="outline">
          <Link href={`/edit-produk/${id}`}>Edit</Link>
        </Button>
      </div>
      ) 
    }
